...
import { isDueDateElement, isMentionElement, isTagElement, isTaskListItemElement } from "@/types/markdown";
...
export const MemoMarkdownRendererCore = ({
  ...
  const markdownComponents: Components = {
    ...
    span: ({ node, ...spanProps }) => {
      ...
      if (node && isDueDateElement(node)) {
        return <DueDateBadge {...spanProps} node={node} />;
      }
